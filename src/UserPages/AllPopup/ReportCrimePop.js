...
import { setComplainVisible, setCreatedCrime, setCrimeVisible, setDropdownVisible } from "../../Redux/appSlice";
...
const ReportCrimePop = () => {
  ...
  const { complainDropdown, createdCrime } = useSelector((state) => state.app);
          ...
          <div className="dropdown-div ">
            ...
            <div className="right-dropdown-div">
              ...
              <div className="all-link">
                <Link onClick={handleCrimeLodge} className="Cancel">
                  Cancel
                </Link>
                <Link onClick={handleCreateCrime} className="Create">Lodge Complain</Link>
              </div>
            </div>
          </div>
        </div>
