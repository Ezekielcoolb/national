...
import { userForgetPasswordReset } from "../../Redux/slices/AuthSlice";
...
const UserPasswordCreation = () => {
  ...
  const { loading, error, restPassword, resetPasswordsuccessMessage } = useSelector((state) => state.auth);
...
useEffect(() => {
 ...
 const handleSubmit = (e) => {
      e.preventDefault();
      if (isValid) {
        dispatch(userForgetPasswordReset(formData));
      }
    };
        ...
        <div className="login-right-all">
          <div className="login-right">
            ...
            <div className="login-right-upper">
              ...
              <p>Securely your account with a password</p>
            </div>
...
<div className="email-sign">
              ...
              <div className="email-sign">
                <Icon
                  ...
                  height="20"
                  style={{
                    color: formData.retype_password ? "#060B13" : "#99A2AF",
                  }}
                />
                <input
                  type={showPassword ? "text" : "password"}
